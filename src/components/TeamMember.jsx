...
const TeamMember = ({ id, teamMembers = [] }) => {
    return (
        <section id={id} className="min-h-screen bg-gradient-to-br from-[#f5ebe0] via-[#e8dcc6] to-[#d6ccc2] relative overflow-hidden">
            ...
            {/* Section Heading */}
            <div className="max-w-8xl mx-auto px-15 pt-24 pb-16 max-[760px]:px-4 max-[760px]:pt-16 max-[760px]:pb-12 animate-fade-in-up relative z-10">
                <div className="text-center">
                    {/* Subtitle */}
                    <p className="text-lg text-[#666] font-medium tracking-wide mb-4 animate-fade-in animation-delay-200 max-[760px]:text-base">
